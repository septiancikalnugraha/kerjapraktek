                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-content">
                            ...
                            <div class="stat-value">Rp 125.5M</div>
                            <div class="stat-change positive">
                                <i class="fas fa-arrow-up"></i> +12.5% bulan lalu
                            </div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-content">
                            ...
                            <div class="stat-change positive">
                                <i class="fas fa-arrow-up"></i> +8.2% bulan lalu
                            </div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-content">
                            ...
                            <div class="stat-change positive">
                                <i class="fas fa-arrow-up"></i> +5.3% bulan lalu
                            </div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-content">
                            ...
                            <div class="stat-change negative">
                                <i class="fas fa-arrow-down"></i> -2.1% bulan lalu
                            </div>
                        </div>
                        ...
                        <ul class="activity-list">
                            <li class="activity-item">
                                ...
                                <div class="activity-content">
                                    <div class="activity-title">Order #12345 - PT. ABC</div>
                            ...
                            <li class="activity-item">
                                ...
                                <div class="activity-content">
                                    <div class="activity-title">Order #12344 - PT. XYZ</div>
                                    <div class="activity-time">Kemarin, 3:15 PM</div>
                                </div>
                            </li>
                            <li class="activity-item">
                                <div class="activity-icon">
                                ...
                                <div class="activity-content">
                                    <div class="activity-title">Order #12343 - PT. Maju</div>
                    ...
                    <div class="card">
                        ...
                        <ul class="activity-list">
                            <li class="activity-item">
                                ...
                                <div class="activity-content">
                                    <div class="activity-title">Order Diselesaikan</div>
                                    <div class="activity-time">Hari ini, 9:00 AM</div>
                                </div>
                            </li>
                            <li class="activity-item">
                                <div class="activity-icon">
                                ...
                                <div class="activity-content">
                                    <div class="activity-title">Stok Barang Diperbarui</div>
                                    <div class="activity-time">Kemarin, 2:30 PM</div>
                                </div>
                            </li>
                            <li class="activity-item">
                                <div class="activity-icon">
